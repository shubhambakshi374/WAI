...
from altus.cloud.kube import PRIVILEGED_SUBRESOURCES
from altus.core.visuals import Table
from altus.tools.base import ToolContext, ToolOutcome
from altus.tools.k8s.base import MAX_LOG_LINES, K8sTool, _rows
...
def _as_yaml(obj: Any) -> str:
    ...
    # marker comes out as "\xABredacted by altus\xBB", and so does every label
