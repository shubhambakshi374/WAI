...
from altus.tools.azure.base import AzureMutatingTool
...
class AzureWriteTool(_ArmChange):
    ...
    description: ClassVar[str] = (
        ...
        "time. Before asking, Altus runs an ARM What-If against your "
...
class AzureDeleteTool(_ArmChange):
    ...
    description: ClassVar[str] = (
        ...
        "offers no preview for a delete, so Altus checks for a resource lock "
...
class AzureActionTool(_ArmChange):
    ...
    description: ClassVar[str] = (
        ...
        "time. ARM offers no preview for an action, so Altus asks RBAC whether "
