...
The layout is in ``altus.render.layout`` --- shared with the terminal-cell back
...
from altus.core.visuals import ResourceGraph
from altus.render.canvas import Canvas, View
from altus.render.layout import Metrics, Placed, caption_with_omissions, forest, layout, walk
from altus.render.palette import Palette

if TYPE_CHECKING:
    from altus.render import Hit
