...
from altus.core.visuals import ResourceGraph, Visual
from altus.render import DARK, LIGHT, Palette, View, render, renderable
from altus.render.capability import Support, resolve
...
class CellMap(Static):
    ...
    def get_content_height(self, container: Any, viewport: Any, width: int) -> int:
        ...
        from altus.render.cells import CELLS
...
def _fallback(model: Visual, palette: Palette) -> Widget:
    ...
    from altus.tui.widgets.visuals import build_text_view
