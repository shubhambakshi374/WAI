...
Reads need no approval. Every mutation runs a server-side dry run first
and puts the server's verdict in the approval prompt --- what the API says
will happen, not what the model claims will happen.
"""
...
from wai.cloud.base import ProtectionMode, Sensitivity
