...
from wai.providers.registry import catalog_for, known_models
...
class ModelPicker(ModalScreen[ModelInfo | None]):
    ...
    def on_mount(self) -> None:
        scope = self.provider or self.wai.session.provider
    ...
    async def filter_models(self, needle: str) -> None:
        ...
        result = await search_models(scope, self.wai.config, self.models, needle)
